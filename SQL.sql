...
CREATE TABLE `game` (
  ...
  `GAME_ReleaseDate` varchar(255) NOT NULL,
  `GAME_Producer` varchar(255) NOT NULL,
  `GAME_Language` varchar(255) NOT NULL,
...
CREATE TABLE `movie` (
  ...
  `MOVIE_ReleaseDate` varchar(255) NOT NULL,
  `MOVIE_Director` varchar(255) NOT NULL,
  `MOVIE_Subject` varchar(255) NOT NULL,
  `MOVIE_Rating` varchar(255) NOT NULL,
  `MOVIE_Language` varchar(255) NOT NULL,
  `MOVIE_CountryOfOrigin` varchar(255) NOT NULL,
  `MOVIE_Comments` varchar(255) NOT NULL,
...
CREATE TABLE `music` (
  ...
  `MUSIC_ReleaseDate` varchar(255) NOT NULL,
  `MUSIC_Artist` varchar(255) NOT NULL,
  `MUSIC_Language` varchar(255) NOT NULL,
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-03-22 11:31:31',NULL),('diagnostics.include_raw','OFF','2024-03-22 11:31:31',NULL),('ps_thread_trx_info.max_length','65535','2024-03-22 11:31:31',NULL),('statement_performance_analyzer.limit','100','2024-03-22 11:31:31',NULL),('statement_performance_analyzer.view',NULL,'2024-03-22 11:31:31',NULL),('statement_truncate_len','64','2024-03-22 11:31:31',NULL);
...
-- Dump completed on 2024-03-27 23:09:50
