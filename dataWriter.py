...
class MovieDatabaseWriter:
    ...
    def insert_actor(self, name: str, gender: Optional[bool] = None, nationality: Optional[str] = None,
        ...
        self.insert_movie_actor(movie_id=movie_id, actor_id=actor_id)
...
# Example usage:
writer = MovieDatabaseWriter(dbname='your_db', user='your_user', password='your_password')

# Inserting a movie and retrieving its ID
movie_id = writer.insert_movie(title='The Shawshank Redemption', imdb_rating=9.3, genre=['Drama', 'Crime'])
